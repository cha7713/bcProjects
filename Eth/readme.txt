...
2. 2세대 블록체인 대표주자 이더리움 구축
 ...
 $ geth --datadir "./ethereum/data" account new <= 2번 수행
   0x89241fB171363A31CB44554f59aFD5F44dcf3bA6 : 소유주
   0xdf427B329dFc66E9DCaBC868C167f558A49B6d14 : 주주
 $ nano Genesis.json
...
3. 이더리움의 사설 네트워크 외부에서 연동하는 방법(RPC)
 ...
 - 원격 접속상황에서
  ...
  $ personal.newAccount('1234')
   "0xadb9eb16338c43f5e6213dc6383d5abb51baca63"
  $ 송금행위 
 ...
 - NodeJS 연동
  ...
  web3는 이더리움 네트워크에 접속하여 RPC 커맨드를 사용할수 있다
   ...
   node_modules/bignumber.js/bignumber.min.js 이파일을 
